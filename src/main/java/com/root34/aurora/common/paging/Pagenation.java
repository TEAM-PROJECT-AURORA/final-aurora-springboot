...
public class Pagenation {
    ...
    /**
    	* @MethodName : getSelectCriteria
    	* @Date : 2023-03-20
    	* @Writer : 오승재
    	* @Method Description : 검색어가 있는 경우
    */
    public static SelectCriteria getSelectCriteria(int pageNo, int totalCount, int limit, int buttonAmount, String searchCondition, String searchValue, String orderCondition) {
...
//		startPage = (((int)((double) pageNo / buttonAmount + 0.9)) - 1) * buttonAmount + 1;
        ...
        if(searchCondition == null && searchValue == null) {
            ...
            selectCriteria = new SelectCriteria(pageNo, totalCount, limit, buttonAmount, maxPage, startPage, endPage, startRow, endRow, searchCondition, searchValue, orderCondition);
        }
